		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "park",
									"targetURL": "#comappparkingappl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappparkingappl-display": {
								"semanticObject": "comappparkingappl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.parkingappl",
									"url": sap.ui.require.toUrl("com/app/parkingappl")
								}
							}
						}
					}
